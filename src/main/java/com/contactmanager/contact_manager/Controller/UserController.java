...
//        redirectAttributes.addAttribute("personal_info_saved", true);
//        m.addAttribute("personal_info_saved", true);
        redirectAttributes.addFlashAttribute("personal_info_saved", true);
    ...
    public String list_educational_info(@ModelAttribute("educational_info_object") Educaion_info educaionInfo,
        ...
        redirectAttributes.addFlashAttribute("educational_info_added_to_list", true);
        // m.addAttribute("Page_No_2", true);
        return "redirect:/user/educational-info";
    }
    ...
    @RequestMapping("/save-educational-info")
    public String list_educational_info(Model m,RedirectAttributes redirectAttributes) {
        try {
            if (!this.educaion_infoList.isEmpty()) {
                redirectAttributes.addFlashAttribute("educational_info_saved", true);
                System.out.println(educaion_infoList);
            } else {
                redirectAttributes.addFlashAttribute("educational_info_not_saved", true);
            }
        } catch (Exception e) {
            // TODO: handle exception
        }
    ...
    public String Save_project_info(@ModelAttribute("project_info_object") Project_info project_info,
        ...
        redirectAttributes.addFlashAttribute("User_project_list", this.project_infosList);
        redirectAttributes.addFlashAttribute("project_info_added_to_list", true);

        return "redirect:/user/project-info";
    }
    ...
    public String list_project_info(Model m,
        ...
        try {
            if (!this.project_infosList.isEmpty()) {
                redirectAttributes.addFlashAttribute("project_info_saved", true);
            }
        } catch (Exception e) {
            redirectAttributes.addFlashAttribute("project_info_not_saved", true);
            // TODO: handle exception
        }
        return "redirect:/user/project-info";
    }
